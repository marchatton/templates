...
- Use `assets/critical-pattern-template.md` for formatting
- Add to `docs/solutions/patterns/cora-critical-patterns.md`
- Cross-reference back to the resolution doc
</step>
...
<decision_gate name="post-capture-menu" blocking="true">
